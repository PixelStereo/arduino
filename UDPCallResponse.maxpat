...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 314.0, 99.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 49.0, 238.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.0, 95.0, 87.0, 20.0 ],
					"text" : "/power $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 581.0, 503.0, 145.0, 22.0 ],
					"text" : "print ##"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 644.0, 468.0, 145.0, 22.0 ],
					"text" : "print #"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 581.0, 390.0, 145.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 158.0, 150.0, 20.0 ],
					"text" : "/power/0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.5, 290.0, 150.0, 22.0 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "o.io.udp 192.168.0.111 8888 9999"
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Applications/Max 6.1/packages/CNMAT_Externals/externals/odot/abstractions/io",
				"patcherrelativepath" : "../../../../../Applications/Max 6.1/packages/CNMAT_Externals/externals/odot/abstractions/io",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
